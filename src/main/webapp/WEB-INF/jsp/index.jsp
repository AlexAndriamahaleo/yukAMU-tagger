...
<nav class="navbar navbar-expand-lg navbar-dark bg-success fixed-top">
    <div class="container">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/progress"> <i class="fas fa-list-ul"></i>
                    Progress Details</a>
            </li>
        </ul>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div id="previews" class="row">
                <div class="col-12">
                    <form id="formdonefilter" action="${pageContext.request.contextPath}/food/filter" method="POST">
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input type="checkbox" class="custom-control-input" id="todoCheck" name="todo">
                            <label class="custom-control-label" for="todoCheck">TODO</label>
                        </div>
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input type="checkbox" class="custom-control-input" id="doneCheck" name="done">
                            <label class="custom-control-label" for="doneCheck">DONE</label>
                        </div>
                        <button name="checkbutton" type="submit" class="btn btn-primary btn-xs">Filter <i
                        ...
                        <c:forEach items="${ foods }" var="food">
                            <li class="list-group-item" id="${ food.id }">
                                <div class="media border p-3">
                                    <img src="${ food.imgurl }" alt="imgurl" class="mr-3 mt-3" style="width:60px;"/>
                                    <div class="media-body">
                                        <h4 class="card-title"> ${ food.name } </h4>
                                        <div class="row">
                                            <div class="col">
                                                <i class="fas fa-circle fa-2x ${ food.tag }"></i>
                                                    ${ food.tag }
                                                <%--TODO : remplir avec le tag + tag comme nom de classe juste au dessus--%>
                                            </div>
                                            <div class="col">
                                                <form id="tagselectform"
                                                      action="${pageContext.request.contextPath}/food/set"
                                                      method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="tagselect"
                                                                name="tag" onchange="this.form.submit()">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <form action="${pageContext.request.contextPath}/food/remove"
                                                      method="POST">
                                                    <input type="hidden" value="${ food.id }" name="id"/>
                                            ...
                                            <div class="col">
                                                <form action="${pageContext.request.contextPath}/food/unset"
                                                      method="POST">
                                                    <input type="hidden" value="${ food.id }" name="id"/>
                                                    <c:choose>
                                                        <c:when test="${ food.done == true}">
                                                            <!-- button si l'element est fait -->
                                                            <button name="buttonFav" type="submit"
                                                                    class="btn btn-success btn-xs"><i class="fas fa-check"></i>
                                                                DONE
                                                            </button>
                                                        </c:when>
                                                        <c:when test="${ food.done == false }">
                                                            <!--  bouton si l'element reste a faire -->
                                                            <button name="buttonFav" type="submit"
                                                                    class="btn btn-warning btn-xs"><i
                                                                    class="fas fa-exclamation"></i> TODO
                                                            </button>
                                                        </c:when>
                                                    </c:choose>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="addfoodform" action="${pageContext.request.contextPath}/food/add"
                                  method="POST">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="imgurlinput">Image Url:</label> <input
                                        type="text" class="form-control" id="imgurlinput" name="imgurl"></input>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"
                                    data-dismiss="modal"
                                    onclick="document.getElementById('addfoodform').submit(); return false;">Confirm
                            </button>
                        </div>
                    </div>
